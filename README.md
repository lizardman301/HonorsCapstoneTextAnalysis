...
Place any text files you wish to analyze into the books folder, and then run textAnalysis.py to generate files in the csv folder.  Use graphMaker.py to generate graphs.
